...
logging.basicConfig(filename='training.log', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')  # Set logging level as needed
...
if __name__=='__main__':
    ...
    for _ in tqdm(range(config.NUM_ITERATIONS),total=config.NUM_ITERATIONS):
            ...
            # print('experience = {0}'.format(experience))
            ...
            if step % config.EVAL_INTERVAL == 0:
                ...
                returns.append(avg_return / config.INIT_CASH)
